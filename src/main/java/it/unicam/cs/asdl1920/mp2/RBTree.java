...
public class RBTree<E extends Comparable<E>> {
     ...
     *
     * @param x un nodo di un albero RBTree
     ...
     *
     * @param n un puntatore a un nodo di un RBTRee
     ...
     */
    private final RBTreeNode sentinella = new RBTreeNode();
     ...
     *
     * @param element l'informazione associata al nodo radice
     ...
     * @throws NullPointerException se l'elemento {E el} è null
     */
     ...
     *
     * @param el l'elemento che etichetta il nodo cercato
     ...
     *
     * @param el l'elemento da cancellare
